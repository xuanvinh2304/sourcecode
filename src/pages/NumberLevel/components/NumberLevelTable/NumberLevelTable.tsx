...
type numberlevelTableProps = {
  capSoList:any,
}


const NumberLevelTable: FC<numberlevelTableProps> = ({capSoList}) => {
  ...
  return (
    <>
      <div className="numberleveltable-container">
        <div onClick={() => history.push('/numberlevel/newnumberlevel')} className="btn-add">
