      ...
      <div className="rightbar-container">
        <div className="avatar">
          <div className="avatar-div">
            <BellOutlined className={ state ? "avatar-icon__toggle" : "avatar-icon" } onClick={toggleBtn} />
            { state ? <Notification /> :
              ''  
            }
          </div>
        ...
        <div className="table1">
          <RingProgress {...config} className="progress-chart" />
        ...
        <div className="table2">
          <RingProgress {...config2} className="progress-chart" />
        ...
        <div className="table3">
          <RingProgress {...config3} className="progress-chart" />
