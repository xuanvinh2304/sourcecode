        ...
        <div className="newnumber-table">
          <div>
            ...
            <div className="new-number-table-btn">
              ...
              <Button type="submit" onClick={showModal} text={"In số"} className="btn-signin mt-5" />
              <Modal title="Số thứ tự được cấp" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} footer={null} width={550}>
                <div style={{ marginLeft: '120px' }}>
                  ...
                  <p style={{ fontFamily: 'Nunito', fontStyle: 'normal', fontWeight: 400, fontSize: '18px', lineHeight: '27px', color: '#282739' }}>DV: Khám răng hàm mặt(tại quầy số 1)</p>
                  <div>
