...
import DashBoardDayChart from './pages/DashBoard/components/DashBoardChart/DashBoardDayChart';
import DashBoardWeekChart from './pages/DashBoard/components/DashBoardChart/DashBoardWeekChart';
import DashBoardMonthChart from './pages/DashBoard/components/DashBoardChart/DashBoardMonthChart';
      ...
      <BrowserRouter>
        <Switch>
          ...
          <Route path="/dashboard" component={DashBoard} exact>
            <Route path="/" component={DashBoardDayChart} exact /> 
            <Route path="/1" component={DashBoardWeekChart} exact /> 
            <Route path="/2" component={DashBoardMonthChart} exact /> 
          </Route>
