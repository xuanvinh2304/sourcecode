      ...
      <div className="add-device-table">
        ...
        <div className="add-device-table__all">
          <div className="add-device-table__all-1">
            ...
            <Input className="add-device__input-hover" value={formik.values.maThietBi} name="maThietBi" placeholder="Nhập mã thiết bị" />
            <p>Tên thiết bị: 
              <span className="color-red">*</span>
            </p> 
            <Input className="add-device__input-hover" value={formik.values.tenThietBi} name="tenThietBi" placeholder="Nhập tên thiết bị" />
            <p>Địa chỉ IP: 
              <span className="color-red">*</span>
            </p> 
            <Input className="add-device__input-hover" value={formik.values.diaChiIP} name="diaChiIP"  placeholder="Nhập địa chỉ IP" />
          </div> 
          ...
          <div className="add-device-table__all-2">
            ...
            <Input className="add-device__input-hover" value={formik.values.tenDangNhap} name="tenDangNhap"  placeholder="Nhập tài khoải" />
            <p>Mật khẩu: 
              <span className="color-red">*</span>
            </p> 
            <Input className="add-device__input-hover" value={formik.values.matKhau} name="matKhau"   placeholder="Nhập mật khẩu" />
          </div>
        </div>
        <div className="add-device-table__child">
          ...
          <Input className="input-last add-device__input-hover" value={formik.values.dichVuSuDung} name="dichVuSuDung"  placeholder="Nhập dịch vụ sử dụng" />
