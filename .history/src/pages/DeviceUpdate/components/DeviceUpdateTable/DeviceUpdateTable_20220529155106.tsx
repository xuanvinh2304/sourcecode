    ...
    onSubmit: (e:any) => {
      ...
      const update = async () => {
        ...
        await updateDoc(thietBiRef, {
          maThietBi: `${formik.values.maThietBi[0]}`,
          tenThietBi: `${formik.values.tenThietBi[0]}`,
          loaiThietBi: `${formik.values.loaiThietBi[0]}`,
          dichVuSuDung: `${formik.values.dichVuSuDung[0]}`,
          tenDangNhap: `${formik.values.tenDangNhap[0]}`, 
          matKhau:  `${formik.values.matKhau[0]}`,
          diaChiIP:  `${formik.values.diaChiIP[0]}`, 
        });
        history.push('/device')
      }
      update();
