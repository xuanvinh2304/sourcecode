...
const DeviceUpdateTable: FC = () => {
  ...
  useEffect(()=> {
    ...
    // if(`${thietBiInfo[0].maThietBi}` === undefined) {
      setInfoThietBi({  
        maThietBi: `${thietBiInfo[1].maThietBi}`,
        tenThietBi: `${thietBiInfo[1].tenThietBi}`,
        loaiThietBi: `${thietBiInfo[1].loaiThietBi}`,
        dichVuSuDung: `${thietBiInfo[1].dichVuSuDung}`,
        tenDangNhap: `${thietBiInfo[1].tenDangNhap}`, 
        matKhau:  `${thietBiInfo[1].matKhau}`,
        diaChiIP:  `${thietBiInfo[1].diaChiIP}`, 
      })
    // }
  }, [thietBiInfo]);
