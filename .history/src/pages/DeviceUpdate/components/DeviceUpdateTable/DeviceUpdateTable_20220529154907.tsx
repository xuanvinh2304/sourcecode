...
const DeviceUpdateTable: FC = () => {
  ...
  const initialValues:initialValuesType = {
    maThietBi: `${infoThietBi.maThietBi[0]}`,
    tenThietBi: `${infoThietBi.tenThietBi[0]}`,
    loaiThietBi: `${infoThietBi.loaiThietBi[0]}`,
    dichVuSuDung: `${infoThietBi.dichVuSuDung[0]}`,
    tenDangNhap: `${infoThietBi.tenDangNhap[0]}`, 
    matKhau:  `${infoThietBi.matKhau[0]}`,
    diaChiIP:  `${infoThietBi.diaChiIP[0]}`, 
  }
