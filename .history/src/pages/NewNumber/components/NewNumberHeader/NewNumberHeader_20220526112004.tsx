    ...
    <>
      <div className="deviceheader-container">
        <div className="deviceheader-title">
          <p className="deviceheader-title--1">Cấp số</p> <RightOutlined /> 
          <p className="deviceheader-title--1 width" onClick={() => history.push('/numberlevel')}>Danh sách cấp số</p> <RightOutlined /> 
          <p className="deviceheader-title--2">Cấp số mới</p>
          <UserHeader />
        </div>
        
        <p className="deviceheader-title--2"></p> 
...
export default NewNumberHeader;