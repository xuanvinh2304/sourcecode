    ...
    <>
      <div className="deviceheader-container">
        <div className="deviceheader-title">
          ...
          <p className="deviceheader-title--1">Danh sách cấp số</p>
          <p className="deviceheader-title--2">Cấp số mới</p>
          <UserHeader />
        </div>
        
        <p className="deviceheader-title--2">Quản lí cấp số</p> 
...
export default NumberLevelHeader;