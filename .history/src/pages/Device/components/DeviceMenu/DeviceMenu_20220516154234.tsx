...
import {  RightOutlined, BellOutlined, AudioOutlined, SearchOutlined } from '@ant-design/icons';
      ...
      <div className="devicemenu-container">
        ...
        <div className="devicemenu-option">
          ...
          <div className="menu--active-state-2">
            <p className="devicemenu-option-sub">Trạng thái kết nối</p>
            <Select
              labelInValue
              defaultValue={{ value: 'all' }}
              style={{ width: 120 }}
          ...
          <div className="menu--active-search">
            <p className="devicemenu-option-sub">Từ khóa</p>
            <Space direction="vertical">
              <Search placeholder="Nhập từ khóa" onSearch={onSearch} style={{ width: 200 }} />
              <input placeholder="Nhập từ khóa" type='text' className='search'/>
