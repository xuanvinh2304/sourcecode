  ...
  return (
    <>
      <div className="sidebar-container">
        ...
        <div className="menu">
          <NavLink to="/dashboard" className="menuItem" activeClassName="active"><TableOutlined /> DashBoard</NavLink>
          <NavLink onClick={() => history.push('/device')} to="#" className="menuItem" activeClassName="active"><DesktopOutlined /> Thiết bị</NavLink>
