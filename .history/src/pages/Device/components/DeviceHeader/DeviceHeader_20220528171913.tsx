...
const DeviceHeader: FC = () => {
  ...
  const onChange = (value: any) => {
    ...
    if(values !== '') {
      const result = thietBiInfo.filter((item: any) => item.tenThietBi === values || item.tenDangNhap === values || item.loaiThietBi === values || item.maThietBi === values || item.diaChi === values);
      console.log(result);
