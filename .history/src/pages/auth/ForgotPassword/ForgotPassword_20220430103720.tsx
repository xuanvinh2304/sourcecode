        ...
        <div className="forgot">
          ...
          <form className="form-size" onSubmit={submitHandler}>
            ...
            <Input 
              ...
              label="Email address"
            />
            <Button text={loading ? "Loading..." : "Send password reset email"} className="btn-color is-fullwidth mt-5" disabled={loading} />
            <Button text="Cancel" onClick={() => history.push('/signin')} className=" mt-5" />
          </form>
        </div>
