...
import { LoadDuLieu } from '../../../store/actions/authActions';
...
const ForgotPassword: FC = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    console.log('authListfdsafdsaf', authList)
    const result = authList.findIndex((item:any)=> item.email === e.target.email.value);
    console.log(result);
  }
