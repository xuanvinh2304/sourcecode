...
import "./Sidebar.css";
import { TableOutlined, DesktopOutlined, QuestionCircleOutlined, AreaChartOutlined } from '@ant-design/icons';
      ...
      <div>
        ...
        <div className="menu">
          <ul>
            ...
            <li className="menuItem"><QuestionCircleOutlined />Dịch vụ</li>
