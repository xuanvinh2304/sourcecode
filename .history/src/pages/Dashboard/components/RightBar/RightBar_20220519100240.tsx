    ...
    <>
      <div className="rightbar-container">
        ...
        <div className="table1">
          <div className="progress-chart__1"><RingProgress {...config} /></div>
        ...
        <div className="table2">
          <RingProgress {...config2} className="progress-chart__2" />
        ...
        <div className="table3">
          <RingProgress {...config3} className="progress-chart__3" />
