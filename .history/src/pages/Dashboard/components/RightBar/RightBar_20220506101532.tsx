    ...
    <>
      <div className="rightbar-container">
        ...
        <div className="table-1">
          ...
          <div className="table-1__item-1">
            <p className="table-1__item-1--number">4.221</p>
            <p className="table-1__item-1--icon">
              <DesktopOutlined /> Thiết bị
            </p>
          </div>
          <div className="table-1__item-2">
            <p>Đang hoạt động</p>
            <p>Ngưng hoạt động</p>
          </div>
          <div className="table-1__item-3">
            <p>3.799</p>
            <p>422</p>
          </div>
        </div>
        ...
        <div className="table-2">
          <RadialBar {...config} style={{ width: '80px', height: '80px' }} />
          <div className="table__item-2">
            <p className="table__item-2--number">276</p>
            <p className="table__item-2--icon">
        ...
        <div className="table-3">
          ...
          <div className="item-1">
            <p className="item-1__number">4.221</p>
            <p className="item-1__icon">
