    ...
    <>
      <div className="rightbar-container">
        ...
        <div className="table-1">
          ...
          <div className="table__item-1">
            <p className="table__item-1--number">4.221</p>
            <p className="table__item-1--icon">
        ...
        <div className="table-2">
          ...
          <div className="item-1">
            <p className="item-1__number">276</p>
