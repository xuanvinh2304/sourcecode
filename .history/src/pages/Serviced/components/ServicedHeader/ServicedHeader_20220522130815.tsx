...
const ServicedHeader: FC = () => {

  return (
    <>
      <div className="servicedheader-container">
        <div className="deviceheader-title">
          <p className="deviceheader-title--1">Dịch vụ</p> <RightOutlined /> 
          <p className="deviceheader-title--2">Danh sách dịch vụ</p>
          <UserHeader />
        </div>
        <p className="deviceheader-title--2">Quản lí dịch vụ</p> 
